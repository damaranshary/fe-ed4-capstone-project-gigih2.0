...
function Footer() {
  return (
    <Box bg={useColorModeValue("gray.50", "black.900")} color={useColorModeValue("black.700", "gray.200")}>
      ...
      <Box borderTopWidth={1} borderStyle={"solid"} borderColor={useColorModeValue("gray.200", "gray.700")}>
        <Container as={Stack} maxW={"6xl"} py={4} direction={{ base: "column", md: "row" }} spacing={4} justify={{ md: "space-between" }} align={{ md: "center" }}>
          <Text>© 2022 Copyright Baca Merdeka. All rights reserved. Team FE-ED4</Text>
